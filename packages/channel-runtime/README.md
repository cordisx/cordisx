...
| Channel Manager public provider                                                                                          | verified                               | Host publishes only `channel-manager/v2`; the standalone `cordisx/plugin-channel` package owns the Manager consumer and simulator service artifact                                                               |
