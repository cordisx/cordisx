...
export function MockAgentTaskPage({ task, tasks, locale, control, onChanged, onReturn }: {
  ...
  return <main className="pg-simulator-task-page" data-playground-simulator data-simulator-task-id={task.sessionId}>
    ...
    <SimulatorTaskScenarioWorkbench locale={locale} task={task} tasks={tasks} control={control} onChanged={onChanged} />
  </main>
}
