...
export const REACT_MANAGER_STYLES = `${scopedTDesignReactCss}\n${HOST_ICON_16PX_CSS}\n${String.raw`
  ...
  .cxr-manager-content-panel:has(.cxr-ui-pan-zoom-canvas[data-fill="true"]) { display: flex; flex-direction: column; overflow: hidden; padding-bottom: 1px; }
  .cxr-manager-content-panel:has(.cxr-ui-pan-zoom-canvas[data-fill="true"]) > .cxr-manager-content-seat { min-width: 0; min-height: 0; flex: 1; overflow: hidden; }
  .cxr-manager-content-seat:has(.cxr-ui-pan-zoom-canvas[data-fill="true"]) > [data-cordisx-manager-page] { height: 100%; min-height: 0; overflow: hidden; }
  [data-cordisx-manager-page]:has(.cxr-ui-pan-zoom-canvas[data-fill="true"]) > [data-cordisx-manager-page-body] { grid-row: 2; height: 100%; min-height: 0; overflow: hidden; }
