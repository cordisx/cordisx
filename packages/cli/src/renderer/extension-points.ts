...
function normalizeAnchor(value: unknown, pointId: string, schemaVersion: 1 | 2 | 3 | 5 | 6 | 7 | 8): CordisXHostExtensionPointAnchorDescriptorV5 {
...
function normalizeDescriptor(value: unknown, schemaVersion: 1 | 2 | 3 | 5 | 6 | 7 | 8): CordisXHostExtensionPointDescriptorV5 {
  ...
  const payloadFamilies = schemaVersion === 8 ? V8_PAYLOAD_FAMILIES : schemaVersion === 7 ? V7_PAYLOAD_FAMILIES : schemaVersion === 6 ? V6_PAYLOAD_FAMILIES : schemaVersion === 5 ? V5_PAYLOAD_FAMILIES : PAYLOAD_FAMILIES
...
export class ExtensionPointDescriptorRegistry {
  ...
  registerCatalog(value: CordisXHostExtensionPointCatalogV1 | CordisXHostExtensionPointCatalogV2 | CordisXHostExtensionPointCatalogV3 | CordisXHostExtensionPointCatalogV5 | CordisXHostExtensionPointCatalogV6 | CordisXHostExtensionPointCatalogV7 | CordisXHostExtensionPointCatalogV8 | unknown): () => void {
    ...
    try {
      ...
      const catalog = value as Partial<CordisXHostExtensionPointCatalogV1 | CordisXHostExtensionPointCatalogV2 | CordisXHostExtensionPointCatalogV3 | CordisXHostExtensionPointCatalogV5 | CordisXHostExtensionPointCatalogV6 | CordisXHostExtensionPointCatalogV7 | CordisXHostExtensionPointCatalogV8>
...
export const CORDISX_BUILTIN_EXTENSION_POINT_CATALOG = Object.freeze({
  ...
  points: Object.freeze([
    ...
    descriptor('session.backdrop', 'surface', 'session.backdrop', 'Session backdrop', 'Projects a structured, pointer-inert ambience and portrait behind the active session.', 'host:layers', 'session-backdrop-presentation', 'stable', 'supported'),
    ...
    descriptor('composer.submit.effects', 'surface', 'composer.submit.effects', 'Composer submit effects', 'Provides a Host-owned transparent canvas to one isolated worker after a semantic composer submit.', 'host:layers', 'transient-canvas-presentation', 'experimental', 'supported'),
