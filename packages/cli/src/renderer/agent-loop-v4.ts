...
function scope(profileId: string, compositionGeneration: string, ownerKey: string): CordisXAgentLoopV4Scope {
...
function authorizationFor<Selected extends Capability>(
  capability: Selected,
