...
export const MANAGER_NAVIGATION_COPY = {
  ...
  'manager.nav.search': { en: 'Search CordisX pages', 'zh-CN': '搜索 CordisX 页面' },
  'manager.nav.search-placeholder': { en: 'Search pages', 'zh-CN': '搜索页面' },
  'manager.nav.search-clear': { en: 'Clear search', 'zh-CN': '清除搜索' },
  'manager.nav.search-empty': { en: 'No matching pages', 'zh-CN': '没有匹配的页面' },
