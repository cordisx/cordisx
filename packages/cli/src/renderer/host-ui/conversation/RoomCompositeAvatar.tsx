...
import { createHostRoomCompositeAvatarProjection, HostRoomCompositeAvatarStack } from '../RoomCompositeAvatar.js'
 ...
 */
export function HostRoomCompositeAvatar(
  { participants, size, label, moreLabel, onOpen }: HostRoomCompositeAvatarProps,
) {
  ...
  return (
    <span className="cxa-room-avatar-seat" data-room-avatar-size={size}>
      ...
      {projection.overflow === 0
        ...
        : (
          <button
            type="button"
            className="cxa-room-avatar-more"
            aria-label={moreLabel(projection.overflow)}
            onClick={onOpen}
          >
            +{projection.overflow}
          </button>
