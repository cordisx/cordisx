...
.cx-agent-identity-avatar-button{display:inline-grid;padding:0;border:0;border-radius:9px;background:transparent;cursor:pointer}.cx-agent-identity-avatar-button:focus-visible{outline:2px solid var(--cx-primary);outline-offset:2px}
