...
export const HOST_ROOM_COMPOSITE_AVATAR_STYLES = String.raw`
  .cordisx-room-composite-seat { position: relative; display: block; width: 16px; height: 16px; box-sizing: border-box; padding: 0; overflow: visible; border: 0; gap: 0; background: transparent; box-shadow: none; pointer-events: none; }
  .cxrv-composite { position: absolute; inset: 0; display: block; width: 16px; height: 16px; box-sizing: border-box; padding: 0; border: 0; gap: 0; background: transparent; box-shadow: none; }
