...
export const HOST_ROOM_COMPOSITE_AVATAR_STYLES = String.raw`
  ...
  .cordisx-room-composite-seat > .cxrv-composite { position: absolute; inset: 0; display: block; box-sizing: border-box; width: 16px; min-width: 16px; max-width: 16px; height: 16px; min-height: 16px; max-height: 16px; gap: 0px; margin: 0; padding: 0; overflow: hidden; border: 0; border-radius: 0; background: transparent; box-shadow: none; }
  .cxrv-participant, .cxrv-overflow { position: absolute; display: grid; box-sizing: border-box; place-items: center; margin: 0; padding: 0; overflow: hidden; border: 1px solid var(--color-background-elevated-secondary,var(--color-background-primary,#181818)); border-radius: 50%; background: var(--color-background-primary,#282828); box-shadow: none; color: var(--color-text-primary,currentColor); }
