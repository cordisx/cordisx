...
| Parser, state, operation, protocol, or other behavior change                         | Relevant checks selected through [Host testing](../docs/testing.md); reuse matching CI evidence and add tests for concrete regression risks |
