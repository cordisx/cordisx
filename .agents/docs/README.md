...
| Document                                                                    | Type                           | Use it for                                                                               |
| --------------------------------------------------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------- |
| [conversation-ui-boundary](conversation-ui-boundary.md)                     | Reference / dated audit        | Plugin page ownership, shared primitives, Shell retirement, retained consumers and gates |
