...
- `dynamic-package-store.md` defines the launcher-owned immutable package
  store, dependency graph, installation journal, crash recovery, and narrow
  Generation Runtime seam for explicit local packages.
