...
const expectedRegistrations = [
  ...
  'examples/plugins/permission-v2-smoke-expanded/index.ts|route|dom-smoke',
  'examples/plugins/permission-v2-smoke/index.ts|page|dom-smoke',
  'examples/plugins/permission-v2-smoke/index.ts|route|dom-smoke',
  ...
  'examples/plugins/slot-showcase/index.ts|page|main.welcome',
  ...
  'examples/plugins/slot-showcase/index.ts|route|main.welcome',
  ...
  'packages/cli/src/plugins/channel/index.ts|page|create',
  'packages/cli/src/plugins/channel/index.ts|page|configuration',
  'packages/cli/src/plugins/channel/index.ts|page|logs',
  'packages/cli/src/plugins/channel/index.ts|page|runtime',
  'packages/cli/src/plugins/channel/index.ts|page|sessions',
  'packages/cli/src/plugins/channel/index.ts|route|settings',
  'packages/cli/src/plugins/channel/index.ts|route|create',
  'packages/cli/src/plugins/channel/index.ts|route|configuration',
  'packages/cli/src/plugins/channel/index.ts|route|logs',
  'packages/cli/src/plugins/channel/index.ts|route|runtime',
  ...
  'tests/fixtures/navigation-collection-plugin.ts|page|new-room',
  'tests/fixtures/navigation-collection-plugin.ts|page|room',
  'tests/fixtures/navigation-collection-plugin.ts|route|new-room',
  'tests/fixtures/navigation-collection-plugin.ts|route|room',
