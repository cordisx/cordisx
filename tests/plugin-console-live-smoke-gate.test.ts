  ...
  it('uses stable Console anchors and fails for every reported invariant', async () => {
    ...
    for (
      const assertion of [
        ...
        'before.failure',
        'silent.entries',
        'silent.automaticWithoutConsole',
        'ui.paused',
        'ui.detailOpened',
        'ui.inspectorMetadataOnly',
        'ui.scopedFiltered',
        'ui.cleared',
        'ui.lunaOnly',
        'ui.nativePayloads',
        'ui.firstLineAtTop',
        'ui.fillsRemainingHeight',
        'ui.logsOnlyConsoleTools',
        'ui.independentEntries',
        'ui.independentEntryCount',
        'ui.mountedEntryCount',
        'ui.levelVisuals',
        'ui.objectExpanded',
        'ui.coverageRemoved',
        'ui.iconToolbar',
        'ui.runtimeConsoleSummary',
        'ui.pointerPaused',
        'ui.pointerPauseDetail.label',
        'ui.pointerPauseDetail.rect',
        'ui.keyboardFocused',
        'ui.keyboardResumed',
        'ui.keyboardResumeDetail.label',
        'ui.toolbarTooltip.text',
        'ui.toolbarTooltip.describedBy',
        'ui.returnLatestVisible',
        'ui.returnedToLatest',
        'ui.lightTheme',
        'ui.darkTheme',
        'ui.screenshotPreparedAtTop',
        'ui.runtimeChrome.runtimeDetailsAbsent',
        'ui.runtimeChrome.diagnosticsCollapsed',
        'ui.runtimeChrome.runtimeStatusOnly',
        'ui.runtimeChrome.diagnosticsExpanded',
        'ui.runtimeChrome.diagnosticsLocalized',
        'ui.runtimeChrome.diagnosticsNoCjk',
        'reload.entries',
        'reload.lifecycle',
        'reload.terminalCount',
        'privacy.structuredOnly',
        'privacy.partialObservability',
      ]
