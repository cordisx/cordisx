...
import { isPublicMarketplaceAddress, normalizeMarketplaceRequestUrl } from '../packages/cli/src/launcher/marketplace.js'

describe('launcher marketplace network boundary', () => {
  it('accepts public HTTPS feed URLs without credentials or fragments', () => {
    expect(
      normalizeMarketplaceRequestUrl('https://raw.githubusercontent.com/cordisx/marketplace/main/marketplace.json')
        .href,
    )
