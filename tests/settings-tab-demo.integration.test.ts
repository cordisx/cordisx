...
describe('settings navigation demo bundle', () => {
  it('projects a first-level Host-owned navigation entry, mounts its controlled body, and cleans it up', async () => {
    ...
    expect(managerStyles).toContain('.cxm-content[data-manager-content-page="true"] > .cxm-manager-content-root { box-sizing: border-box; padding: var(--cx-manager-content-block-start) var(--cx-manager-content-inline) var(--cx-manager-content-block-end); }')
